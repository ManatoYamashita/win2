...
const faqItems = [
  {
    ...
    answer:
      "WIN×Ⅱは、保険・不動産・転職・エンタメなど、暮らしに役立つサービスをワンストップで選べるアフィリエイトブログプラットフォームです。300件以上のサービスをご紹介し、ご成約時にキャッシュバックも受け取れます。",
  },
  {
  ...
  },
  {
    ...
    answer:
      "会員登録後、掲載サービスをご利用いただき、成果が承認されると、キャッシュバックがマイページに反映されます。キャッシュバックの受取方法や条件は、各サービスのページで詳しくご確認いただけます。",
  },
  {
  ...
  },
  {
    question: "退会はできますか？",
    answer:
      "はい、いつでも退会いただけます。マイページの設定から退会手続きを行うことができます。退会後も、過去のキャッシュバック履歴は一定期間保持されます。",
  },
  {
    question: "個人情報は安全ですか？",
    answer:
