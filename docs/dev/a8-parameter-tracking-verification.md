...
2. **規約適合性:** キャッシュバックモデルがA8.net利用規約に違反しないか
...
**目的:** キャッシュバックモデルがA8.net利用規約に違反しないか確認
...
**質問2: キャッシュバックモデルの規約適合性**
```
件名: 会員向けキャッシュバックサービスの利用規約について

お世話になっております。メディア会員の[氏名]です。

弊社では、会員様に対してアフィリエイト報酬の一部を
キャッシュバック（ポイント還元）するサービスを検討しております。

パラメータ計測機能のガイドに「ポイントサイト向けではない」
という記載がありますが、これは会員向けのキャッシュバックサービスも
含まれますでしょうか。
...
2. [ ] AFB統合を優先して進める
3. [ ] A8.netは集計用のみで使用（会員別キャッシュバックなし）
